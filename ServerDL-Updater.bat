...
SETLOCAL ENABLEDELAYEDEXPANSION
	...
	:: If You Do Not Know The AppID You Can Probably FInd it On This Site   https://steamdb.info/
	:: Set your AppID example AppID=739590
    SET AppID=


    :: DEFINE the following variables where applicable to your install
	:: Use this " %~dp0 " for file directory if you want everything saved to the same folder you run This batch file from.
